...
class StoreCourseRequest extends FormRequest
{
    ...
    /**
     * A course code must be unique within its (offering, level, academic year)
     * cohort — surfaced as a 422 rather than letting the composite DB index throw
     * (AUDIT.md AUD-017). The check spans soft-deleted rows, matching the index.
     */
    private function uniqueCodeRule(): Unique
    {
        return Rule::unique('courses', 'code')->where(fn ($query) => $query
