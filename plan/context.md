...
**RESUME POINT (next session):** continue `feat/course-management`. Remaining after #11: #12 lecturer-absence, #18 notif strategy, #20 multi-role switcher (B7, held), #22 shadcn→PrimeVue (opportunistic), #30 CSV import, #37 Mailtrap walkthrough (manual), #39 reference caching (blocked).
