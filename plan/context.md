...
**STATUS:** #11 is feature-complete — C0–C4 all shipped, open as **PR #58** (closes #11); final gate green (full suite 677 tests / 2443 assertions). Remaining backlog: #12 lecturer-absence, #18 notif strategy, #20 multi-role switcher (B7, held), #22 shadcn→PrimeVue (opportunistic), #30 CSV import, #37 Mailtrap walkthrough (manual), #39 reference caching (blocked).
