...
- **Omissions audit** (parallel fork over plan/*.md + context.md + project-brief + docs vs shipped routes/controllers/pages/mailables). **Four untracked findings, ranked; NOT yet filed as issues — the owner paused the session before task #4 ("We shall proceed later"):**
...
- **Next resume point:** merge PR #79 when CI is green; then task #4 — discuss + file backlog issues for findings 1–4 (recommended in that order).
